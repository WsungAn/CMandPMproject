...
public class GetAllOrderResponse {
    ...
    public GetAllOrderResponse(Long id, Long customerId, String customerEmail, String orderNo, Long productId, Integer quantity, Integer totalPrice, LocalDateTime createdAt, Status status, Admin admin) {
        this.id = id;
